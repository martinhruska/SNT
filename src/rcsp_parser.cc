 ...
 * \return error code
 */
int Parser::parse(RCSPInstance& instance, const char* source)
{
...
int Parser::parsePSPInfo(RCSPInstance& instance, std::string& line)
{
    char* cLine;
    char * pEnd;
 ...
 */
int Parser::parsePrecedenceLine(RCSPInstance& instance, std::string& line)
{
    char* cLine;
    char * pEnd;
 ...
 */
int Parser::parseDemandLine(RCSPInstance& instance, std::string& line)
{
    char* cLine;
    char * pEnd;
    const int job = strtol(line.c_str(),&pEnd,10);
...
int Parser::parseResourcesLine(RCSPInstance& instance, std::string& line)
{
    char* cLine;
    char* pEnd;
    for(int i = 0; i < instance.resources_; ++i)
 ...
 */
void Parser::toString(RCSPInstance& instance)
{
